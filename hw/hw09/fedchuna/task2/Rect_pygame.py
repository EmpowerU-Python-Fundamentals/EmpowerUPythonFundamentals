...
while run:
    ...
    # while COORD_X > 0 or COORD_X < WIDTH_DISPLAY - WIDTH_RECTANGLE or COORD_Y > 0 or COORD_Y < HEIGHT_DISPLAY - HEIGHT_RECTANGLE:
    # if COORD_X > 0 or COORD_X < WIDTH_DISPLAY - WIDTH_RECTANGLE:
    ...
    if keys[pygame.K_RIGHT] and COORD_X < WIDTH_DISPLAY - WIDTH_RECTANGLE:
            COORD_X = COORD_X+DELTA_STEP
    # if COORD_Y > 0 or COORD_Y < HEIGHT_DISPLAY - HEIGHT_RECTANGLE:
